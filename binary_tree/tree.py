...
# I programmed the various `walk_...` methods as generators.
# Another is to create an iterator object in your language's way and return
# that iterator.  If nothing else, create a list during the walk and return
# the list (this method uses more memory).
